                                    ...
                                    <li{!! (Request::query('status')=='Undeployable' ? ' class="active"' : '' ) !!}><a
                                        ...
                                        <li{!! (Request::query('status')=='byod' ? ' class="active"' : '' ) !!}><a
                                            ...
                                            <li{!! (Request::query('status')=='Archived' ? ' class="active"' : '' ) !!}>
                                                <a href="{{ url('hardware?status=Archived') }}"><i
                                                        class="fas fa-times text-red fa-fw"></i>
                                                    {{ trans('general.all') }}
                                                ...
                                                <li{!! (Request::query('status')=='Requestable' ? ' class="active"' : ''
                                                    ...
                                                    <li{!! (Request::is('hardware/audit/due') ? ' class="active"' : '' )
                                                        ...
                                                        <li{!! (Request::is('hardware/audit/overdue')
                                                            ? ' class="active"' : '' ) !!}>
                                                            <a href="{{ route('assets.audit.overdue') }}">
                                                                <i
                                                                    class="fas fa-exclamation-triangle text-red fa-fw"></i>
                                                            ...
                                                            <li{!! (Request::is('hardware/quickscancheckin')
                                                                ? ' class="active"' : '' ) !!}>
                                                                ...
                                                                <li{!! (Request::is('hardware/bulkcheckout')
                                                                    ? ' class="active"' : '' ) !!}>
                                                                    ...
                                                                    <li{!! (Request::is('hardware/requested')
                                                                        ...
                                                                        @can('create', \App\Models\Asset::class)
                                                                        <li{!! (Request::query('Deleted')
                                                                            ? ' class="active"' : '' ) !!}>
                                                                            <a
                                                                                href="{{ url('hardware?status=Deleted') }}">
